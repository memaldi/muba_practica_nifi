...
curl -L -O https://dlcdn.apache.org/nifi/2.8.0/nifi-2.8.0-bin.zip
...
cp /home/ec2-user/muba_practica_nifi/nifi.properties /home/ec2-user/nifi-2.8.0/conf/
#chown -R ec2-user:ec2-user /home/ec2-user/nifi-2.8.0/
/home/ec2-user/nifi-2.8.0/bin/nifi.sh start
